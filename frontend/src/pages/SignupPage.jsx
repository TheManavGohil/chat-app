...
export const SignupPage = () =>{
    ...
    return <>
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 pt-8">
        <div className="flex flex-col h-screen p-6 sm:p-12">
            <div className="w-full max-w-md space-y-6 mx-auto">
                ...
                <button onClick={handleGoogleSignup} className="btn btn-outline w-full flex items-center justify-center gap-2">
